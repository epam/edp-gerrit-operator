...
replace (
	...
	github.com/epam/edp-cd-pipeline-operator/v2 => github.com/epam/edp-cd-pipeline-operator/v2 v2.3.0-58.0.20210420115140-ab0265198403
	...
	github.com/epam/edp-gerrit-operator/v2 => ./
)
