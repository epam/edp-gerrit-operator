...
func (_m *PlatformService) CreateConfigMap(instance *v1alpha1.Gerrit, configMapName string, configMapData map[string]string) error {
	ret := _m.Called(instance, configMapName, configMapData)

	var r0 error
	if rf, ok := ret.Get(0).(func(*v1alpha1.Gerrit, string, map[string]string) error); ok {
...
func (_m *PlatformService) CreateEDPComponentIfNotExist(gerrit v1alpha1.Gerrit, url string, icon string) error {
	ret := _m.Called(gerrit, url, icon)

	var r0 error
	if rf, ok := ret.Get(0).(func(v1alpha1.Gerrit, string, string) error); ok {
...
func (_m *PlatformService) GenerateKeycloakSettings(instance *v1alpha1.Gerrit) (*[]v1.EnvVar, error) {
	ret := _m.Called(instance)

	var r0 *[]v1.EnvVar
	if rf, ok := ret.Get(0).(func(*v1alpha1.Gerrit) *[]v1.EnvVar); ok {
		r0 = rf(instance)
	} else {
		if ret.Get(0) != nil {
...
func (_m *PlatformService) GetDeploymentSSHPort(gerrit *v1alpha1.Gerrit) (int32, error) {
...
func (_m *PlatformService) IsDeploymentReady(instance *v1alpha1.Gerrit) (bool, error) {
	ret := _m.Called(instance)
...
func (_m *PlatformService) PatchDeploymentEnv(gerrit v1alpha1.Gerrit, env []v1.EnvVar) error {
	ret := _m.Called(gerrit, env)

	var r0 error
	if rf, ok := ret.Get(0).(func(v1alpha1.Gerrit, []v1.EnvVar) error); ok {
		r0 = rf(gerrit, env)
	} else {
		r0 = ret.Error(0)
	}
