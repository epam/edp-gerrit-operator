...
import (
	...
	v1 "github.com/epam/edp-gerrit-operator/v2/api/v1"
)
...
// CreateSecret provides a mock function with given fields: gerrit, name, data, labels
...
func (_m *PlatformService) GetPods(namespace string, filter *metav1.ListOptions) (*corev1.PodList, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string, *metav1.ListOptions) (*corev1.PodList, error)); ok {
...
func (_m *PlatformService) IsDeploymentReady(instance *v1.Gerrit) (bool, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for IsDeploymentReady")
	}

	var r0 bool
	var r1 error
	if rf, ok := ret.Get(0).(func(*v1.Gerrit) (bool, error)); ok {
		return rf(instance)
	}
...
func (_m *PlatformService) PatchDeploymentEnv(gerrit *v1.Gerrit, env []corev1.EnvVar) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for PatchDeploymentEnv")
	}
